...
#define SPI_CLK_FILE "/sys/devices/virtual/input/lge_fingerprint/clk_enable"
#define SPI_PREP_FILE "/sys/devices/virtual/input/lge_fingerprint/spi_prepare"
#define SPI_WAKE_FILE "/sys/devices/virtual/input/lge_fingerprint/wakeup_enable"
#define SPI_IRQ_FILE "/sys/devices/virtual/input/lge_fingperprint/irq"
...
int device_enable()
{
    if (sysfs_write(SPI_PREP_FILE,"1")< 0) {
        return -1;
    }
...
int device_disable()
{
    ...
    if (sysfs_write(SPI_PREP_FILE,"0")< 0) {
        return -1;
    }
    return 1;
}
